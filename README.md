<p align="center">
  <a href="https://jipjangbu.minseop0920370667.chatgpt.site">
    <img src="docs/assets/jipjangbu-cover.png" alt="집장부 — 고객 · 매물 · 업무를 한곳에" width="100%" />
  </a>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Cloudflare-D1%20%2B%20R2-145447?logo=cloudflare&amp;logoColor=white" alt="Cloudflare D1 · R2" />
</p>
...
<a href="docs/assets/journal-search.png"><img src="docs/assets/journal-search.png" alt="업무일지: 주소 검색에 일치한 연결 매물을 강조하는 화면. 합성 데이터 사용." width="100%" /></a>

<table>
  <tr>
    <td width="50%" valign="top">
      <a href="docs/assets/work-detail.png"><img src="docs/assets/work-detail.png" alt="업무 내용 보기: 연결된 여러 매물의 주소·가격·물건지를 비교하는 화면. 합성 데이터 사용." width="100%" /></a>
      <p><strong>내용을 먼저 읽고, 필요할 때 수정</strong><br />긴 메모와 여러 매물을 펼쳐 보고 각 이력으로 이동합니다.</p>
    </td>
    <td width="50%" valign="top">
      <a href="docs/assets/safe-deletion.png"><img src="docs/assets/safe-deletion.png" alt="삭제 확인: 저장된 내용과 연결 매물, 휴지통 복구 안내. 합성 데이터 사용." width="100%" /></a>
...
<p align="center">
  <a href="docs/assets/mobile-trash.png"><img src="docs/assets/mobile-trash.png" alt="휴대폰 큰 글씨 모드에서 확인하는 휴지통 목록. 합성 데이터 사용." width="320" /></a>
</p>
...
| **매물 관리** | 전체 매물 조회 · 종류·이름·동·호수 정렬 · 누적 이력·업무구분별 조회 · 기존 매물로 새 업무 작성 |
