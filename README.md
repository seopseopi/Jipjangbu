...
<p align="center">
  <strong>아버지의 엑셀 장부에서 출발한, 실사용 중심의 부동산 업무관리.</strong><br />
  기록을 옮기는 것에서 시작해, 찾고 · 읽고 · 수정하고 · 복구하는 흐름까지.
</p>
...
| 관점 | 프로젝트에서 다룬 범위 |
| :--- | :--- |
| 사용자 | 엑셀에 익숙한 부동산 실무자 · PC와 휴대폰 · 사무실과 집 |
...
| 화면 | 할 수 있는 일 |
| :--- | :--- |
| **오늘의 업무** | 상단 요약은 오늘 업무 → 다가오는 일정 → 진행 중 매물 → 전체 고객 · 업무·7일 일정 먼저 확인 · 챙겨야 할 일은 보조 영역 |
