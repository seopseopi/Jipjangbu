...
| **매물 관리** | 건물·동·호수별 조회 · 최근 저장 내용과 엑셀 원본 메모 구분 · 업무일/저장 시각 표시 · 기존 이력을 보존하는 매물 수정 기록 |
...
| 검증·기능 | 값 | 의미 |
| :--- | ---: | :--- |
| 자동 테스트 | **334개 통과** | 실제 API/SQL와 화면 이벤트로 최근 저장 내용·업무일/저장 시각·단지 묶음·엑셀 달력 규칙·이력 저장·검색·복귀·백업 등 회귀 검증 |
