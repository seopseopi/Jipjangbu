...
export const WorkSummaryProperties = new Function("React", "getWorkProperties", "workPropertyLabel", `${compiled}; return WorkSummaryProperties;`)(React, getWorkProperties, workPropertyLabel);
